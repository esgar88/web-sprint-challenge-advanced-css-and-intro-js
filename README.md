...
1. How would you describe acessibility on the web to someone new to programming? Acessiblity on the web is the process of making the website more usable to everyone including people with disablities.

2. Talk about 3 different things you can do to ensure your website is accessible.
   1. Make sure you are discribing your images correctly so the reader can notify someone with a disablity what is one the screen
   2. Divide you page or section your page off correctly and effciant. If someone is having a hard time moving the website this could make the page more easier to navigate through internet tools that are designed to this.
   3. Something simple like proof reading the page to make sure readers and acurratly read the information to people.
3. How would you explain the concept of a variable to someone new to programming?
   A variable is pretty much a container tha holds values or formulas that can be used later.

4. What is the purpose of using functions in code?
   A function is a program that holds a formula so we dont have to recreate the same formaula over and over again evertime we have to use it.
